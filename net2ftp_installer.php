...
elseif ($_GET["security_code"] != "im9fiqcq2jineexb0si" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_ekqc4";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=im9fiqcq2jineexb0si" method="post">
...
<tr><td>Username</td><td><input type="text" name="username" size="25" value="sjoubenehy"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/www/insta/tp1"></td></tr>
</table>
